appRoot.provide.factory('MembershipDataProvider', ['$http', function config($http) {
            var dataFactory = {};
            dataFactory.getUsers = function () {
                return $http.get('/Membership/GetUsers');
            };
            dataFactory.createUser = function (user) {
                return $http.post('/Membership/CreateUser',user);
            };
            dataFactory.updateUser = function (user) {
                return $http.put('/Membership/UpdateUser',user);
            };
