angular.module('DConfig').controllerProvider.register('ApplicationsManager.UploadAppController', function ($scope, $location, BreadCrumpsProvider, UserMessagesProvider, ApplicationsManagerDataProvider, EventsProvider, $modal) {
